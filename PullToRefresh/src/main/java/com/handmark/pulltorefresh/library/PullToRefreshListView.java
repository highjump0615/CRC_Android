...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (rect.height() >= bottom) {
            ...
            Log.e("PullToRefreshListView", "left = " + left);
            Log.e("PullToRefreshListView", "top = " + top);
            Log.e("PullToRefreshListView", "right = " + right);
            Log.e("PullToRefreshListView", "bottom = " + bottom);
            Log.e("PullToRefreshListView", "==============================================================================");
        }
    }*/
